...
const DEPLOYMENTS: DeploymentSummary[] = [
  ...
  },
  {
    ...
    error_detail: "boom", is_rollback_of: null, components_deployed: null, components_total: null, tests_completed: null, tests_total: null, run_by: null, items: [], pipeline_run_id: null, coverage_percent: null, coverage_details: null,
  },
];
  ...
  it("excludes deployments that were started as a pipeline step", async () => {
    vi.mocked(client.fetchDeployments).mockResolvedValue([
      ...DEPLOYMENTS,
      {
        ...DEPLOYMENTS[0],
        id: "d3",
        pipeline_run_id: "run1", coverage_percent: null, coverage_details: null,
      },
    ]);
    vi.mocked(client.fetchConnections).mockResolvedValue([
      { id: "src1", type: "org", nickname: "DevSpare", createdAt: "", lastUsedAt: null, orgType: "sandbox" },
