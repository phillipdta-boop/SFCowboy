...
describe("App", () => {
  ...
  it("widens the main content area on a deployment detail page, which can also render the component table", () => {
    ...
    vi.mocked(client.fetchDeployment).mockResolvedValue({
      ...
      error_detail: null, is_rollback_of: null, components_deployed: null, components_total: null, tests_completed: null, tests_total: null, run_by: null, components: [], run_tests: [], items: [], pipeline_run_id: null, coverage_percent: null, coverage_details: null, target_connection_type: "org",
    });
    render(
